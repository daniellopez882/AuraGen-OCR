...
from auragen.common.auragen.processor import NOMATH_TOKEN
...
from auragen.input.processing import (
    convert_if_not_rgb,
    slice_polys_from_image,
    slice_bboxes_from_image,
)
from auragen.recognition.postprocessing import fix_unbalanced_tags
from auragen.recognition.util import (
    sort_text_lines,
...
from auragen.foundation.util import detect_repeat_token, prediction_to_polygon_batch
from auragen.recognition.schema import TextLine, OCRResult, TextChar
