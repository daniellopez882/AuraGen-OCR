...
After the model loads, upload an image or a pdf, then draw a box around the equation or text you want to OCR by clicking and dragging. auragen will convert it to Markdown with LaTeX math on the right.
"""
