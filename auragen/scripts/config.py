...
import click
import os
from auragen.input.load import load_from_folder, load_from_file
...
class CLILoader:
    ...
    def common_options(fn):
        ...
        fn = click.option("--output_dir", type=click.Path(exists=False), required=False, default=os.path.join(settings.RESULT_DIR, "auragen"), help="Directory to save output.")(fn)
