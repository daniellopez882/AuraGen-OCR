...
from auragen.models import load_predictors

from auragen.debug.draw import draw_polys_on_image, draw_bboxes_on_image

from auragen.debug.text import draw_text_on_image
from PIL import Image, ImageDraw
from auragen.table_rec import TableResult
from auragen.detection import TextDetectionResult
from auragen.recognition import OCRResult
from auragen.layout import LayoutResult
from auragen.settings import settings
from auragen.common.util import rescale_bbox, expand_bbox
...
This app will let you try auragen, a multilingual OCR toolkit.
...
Find the project [here](https://github.com/VikParuchuri/auragen).
""")
