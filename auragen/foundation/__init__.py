...
from auragen.common.auragen import auragenModelOutput
from auragen.common.xla import mark_step
from auragen.common.predictor import BasePredictor

from auragen.foundation.loader import FoundationModelLoader
from auragen.foundation.util import (
    detect_repeat_token,
)
from auragen.common.auragen.schema import TaskNames
from auragen.foundation.cache.dynamic_ops import DynamicOpsCache
from auragen.foundation.cache.static_ops import StaticOpsCache

from auragen.settings import settings
from auragen.logging import get_logger, configure_logging
...
class FoundationPredictor(BasePredictor):
    ...
    def process_outputs(
        self, outputs: auragenModelOutput, max_lookahead_tokens: Optional[int] = None
