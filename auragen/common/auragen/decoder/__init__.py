...
class Qwen2Attention(nn.Module):
    ...
    def __init__(self, config: auragenDecoderConfig, layer_idx: int):
        super().__init__()
        self.config = config
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        if self.config._attn_implementation != "eager":
            if self.config._attn_implementation == "sdpa" and kwargs.get(
                ...
                # Needed for CPU -> GPU
                from auragen.common.auragen.flash_attn_utils import (
                    flash_attn_decode,
                    flash_attn_prefill,
                )
...
class Qwen2RotaryEmbedding(nn.Module):
    def __init__(self, config: auragenDecoderConfig, device=None):
        super().__init__()
...
class Qwen2PreTrainedModel(auragenPreTrainedModel):
    config_class = auragenDecoderConfig
...
class auragenDecoderModel(Qwen2PreTrainedModel):
    """
    ...
    def __init__(self, config: auragenDecoderConfig):
