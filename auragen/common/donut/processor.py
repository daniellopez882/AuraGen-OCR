...
class auragenEncoderImageProcessor(S3DownloaderMixin, ImageProcessingMixin):
    def __init__(
        self,
        *args,
        max_size=None,
    ...
    def process_inner(self, images: List[np.ndarray]):
        ...
        if self.do_align_long_axis:
            ...
            images = [
                auragenEncoderImageProcessor.align_long_axis(
        ...
        images = [
            auragenEncoderImageProcessor.numpy_resize(img, self.max_size, self.resample)
            for img in images
        ]
        ...
        images = [
            auragenEncoderImageProcessor.pad_image(
                image=image,
                size=max_size,
        ...
        images = [
            auragenEncoderImageProcessor.normalize(
                img,
