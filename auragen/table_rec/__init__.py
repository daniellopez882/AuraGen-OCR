...
from auragen.table_rec.schema import TableCell, TableRow, TableCol, TableResult
from auragen.common.polygon import PolygonBox
from auragen.settings import settings
from auragen.table_rec.loader import TableRecModelLoader
from auragen.table_rec.model.config import BOX_PROPERTIES, SPECIAL_TOKENS, BOX_DIM, CATEGORY_TO_ID, MERGE_KEYS, \
    MERGE_VALUES
from auragen.table_rec.shaper import LabelShaper
