...
from auragen.table_rec.model.decoder import auragenTableRecDecoder
from auragen.table_rec.model.encoder import DonutSwinModel
...
class TableRecEncoderDecoderModel(S3DownloaderMixin, auragenPreTrainedModel):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if decoder is None:
            decoder = auragenTableRecDecoder(
