...
from auragen.common.adetr.decoder import auragenADETRDecoderModel, auragenADETRDecoderPreTrainedModel
from auragen.table_rec.model.config import TableRecModelOutput
...
class auragenTableRecDecoder(auragenADETRDecoderPreTrainedModel):
    _tied_weights_keys = None

    def __init__(self, config, **kwargs):
        super().__init__(config)
        embed_tokens = LabelEmbedding(config)
        self.model = auragenADETRDecoderModel(
            config,
