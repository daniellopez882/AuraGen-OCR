...
class auragenTableRecConfig(S3DownloaderMixin, PretrainedConfig):
    ...
    def __init__(self, **kwargs):
        ...
        if "encoder" in kwargs:
            ...
            decoder_config = auragenTableRecDecoderConfig()
...
class auragenTableRecDecoderConfig(PretrainedConfig):
    model_type = "auragen_tablerec"
