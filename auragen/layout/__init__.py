...
from auragen.foundation import FoundationPredictor, TaskNames
from auragen.foundation.util import prediction_to_polygon_batch
from auragen.input.processing import convert_if_not_rgb
from auragen.layout.label import LAYOUT_PRED_RELABEL
from auragen.common.util import clean_boxes
